...
func (a *TransferBillsApiService) CreateTransferBill(ctx context.Context, req CreateTransferBillRequest) (resp *CreateTransferBillResponse, result *core.APIResult, err error) {
	...
	global.Lg.Info("发起商家转账到用户零钱", zap.Any("localVarHeaderParams", localVarHeaderParams), zap.Any("localVarQueryParams", localVarQueryParams), zap.Any("localVarPostBody", localVarPostBody), zap.Any("localVarHTTPContentType", localVarHTTPContentType))
